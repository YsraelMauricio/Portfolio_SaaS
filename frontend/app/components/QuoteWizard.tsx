...
import ProductTypeCard from '@/app/components/ProductTypeCard';
import ModifierPanel from '@/app/components/ModifierPanel';
    ...
    return (
      <div className="max-w-md mx-auto py-20 text-center">
        <div className="bg-red-50 border border-red-200 rounded-xl p-6">
          <p className="text-red-600 font-medium">Failed to load quote configuration</p>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-gray-500">
          Configure your project and see an instant price estimate
        </p>
      </div>
