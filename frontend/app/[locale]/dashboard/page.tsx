...
export default function DashboardHome() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-zinc-900 dark:text-[#FAFAFA]">{t('title')}</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
          <p className="text-sm font-medium text-zinc-500 dark:text-[rgba(250,250,250,0.55)]">{t('activeProjects')}</p>
          <p className="text-3xl font-bold text-zinc-900 dark:text-[#FAFAFA] mt-2">{activeProjects.length}</p>
        </div>
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
          <p className="text-sm font-medium text-zinc-500 dark:text-[rgba(250,250,250,0.55)]">{t('deliveredProjects')}</p>
          <p className="text-3xl font-bold text-zinc-900 dark:text-[#FAFAFA] mt-2">{deliveredProjects.length}</p>
        </div>
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
          <p className="text-sm font-medium text-zinc-500 dark:text-[rgba(250,250,250,0.55)]">{t('savedQuotes')}</p>
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div>
            <p className="font-semibold text-zinc-900 dark:text-[#FAFAFA]">{t('viewProjects')}</p>
        ...
        >
          <div>
            <p className="font-semibold text-zinc-900 dark:text-[#FAFAFA]">{t('savedQuotes')}</p>
            <p className="text-sm text-zinc-500 dark:text-[rgba(250,250,250,0.55)] mt-1">
              {t('reviewQuotes')}
            </p>
          </div>
