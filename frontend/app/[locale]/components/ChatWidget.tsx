...
export default function ChatWidget() {
  ...
  if (!isOpen) {
    return (
      <button
        type="button"
        onClick={handleOpen}
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#6D28D9] text-white rounded-full shadow-lg hover:bg-[#5B21B6] transition-colors flex items-center justify-center"
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      >
        {/* ---- Header ---- */}
        <div className="flex items-center justify-between px-4 py-3 bg-[#6D28D9] text-white shrink-0">
          ...
          <>
                    ...
                    >
                      ...
                      {msg.isStreaming && (
                        <span className="inline-flex gap-0.5 ml-1">
                          <span
                            className={`w-1.5 h-1.5 bg-zinc-400 dark:bg-zinc-500 rounded-full ${motionClass}`}
                  ...
                  <div className="flex justify-start">
                    <div className="bg-zinc-100 dark:bg-zinc-800 rounded-2xl rounded-bl-md px-4 py-3">
                      <div className="flex gap-1">
                        <span
                          className={`w-2 h-2 bg-zinc-400 dark:bg-zinc-500 rounded-full ${motionClass}`}
                          style={{ animationDelay: '0ms' }}
                        />
                        <span
                          className={`w-2 h-2 bg-zinc-400 dark:bg-zinc-500 rounded-full ${motionClass}`}
            ...
            {escalationPhase === 'channel' && (
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <button
                  ...
                  className="w-full text-center text-xs text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 py-2 transition-colors"
                >
                  {t('escalation.cancel')}
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={8}
                    className="w-full rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-800 dark:text-zinc-200 resize-none focus:outline-none focus:ring-2 focus:ring-[#6D28D9]/50"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl text-sm font-medium text-white bg-[#6D28D9] hover:bg-[#5B21B6] transition-colors"
                >
            ...
            {escalationPhase === 'confirming' && selectedChannel && (
              <div className="flex-1 flex flex-col items-center justify-center p-4 text-center space-y-3">
                <div className="w-10 h-10 border-4 border-[#6D28D9]/30 border-t-[#6D28D9] rounded-full motion-safe:animate-spin" />
            ...
            {escalationPhase === 'success' && selectedChannel && (
              <div className="flex-1 flex flex-col items-center justify-center p-4 text-center space-y-3">
                ...
                <button
                  type="button"
                  onClick={handleClose}
                  className="text-xs text-[#6D28D9] hover:underline mt-2"
                >
                  {t('chat.close')}
                </button>
              </div>
              ...
              <div className="border-t border-zinc-200 dark:border-zinc-800 p-3 shrink-0">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    disabled={isSending}
                    className="flex-1 px-4 py-2.5 text-sm rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#6D28D9]/50 disabled:opacity-50"
                  />
                  <button
                    type="button"
                    onClick={handleSend}
                    disabled={!inputValue.trim() || isSending}
                    className="p-2.5 bg-[#6D28D9] text-white rounded-xl hover:bg-[#5B21B6] transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                ...
                <button
                  ...
                  className="w-full mt-2 py-2 text-xs font-medium text-zinc-500 dark:text-zinc-400 hover:text-[#6D28D9] dark:hover:text-[#6D28D9] transition-colors"
                >
                  {t('escalation.title')}
                </button>
              </div>
